...
def main(page: Page):
    nametxt = TextField(label="Staff username")
    jobtxt = TextField(label="Job Position")
    ...
    def registernow(e):
        ...
        page.snack_bar = SnackBar(
            Text("User created Success", size=30),
            bgcolor="blue"
        )
    ...
    page.add(
        Column([
            Text("Staffs FaceID Login System", size=32, weight="bold", color="blue"),
            nametxt,
            jobtxt,

            Row([
                ElevatedButton("New Staff Scan",
